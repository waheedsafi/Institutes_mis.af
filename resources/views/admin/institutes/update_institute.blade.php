...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Update Institute @foreach ($instdata as $id => $data)
                            @php
                                $id = $data->Inid;
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('updateinstitute', $id) }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" value="{{ $create_date }}"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input name="location" id="location" class="form-control" cols="30" rows="5"
                                        value="{{ $location }}">
                                </div>
                            </div>
