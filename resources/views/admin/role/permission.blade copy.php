...
<table  id="roletable" class="table cell-border table-striped ">
    ...
    <!-- /.card -->
        ...
        {{-- <div class="modal fade bg-transparnt " id="add_institute" tabindex="-1" aria-labelledby="exampleModalLongTitle" aria-hidden="true"> --}}
            <div class="modal fade" id="institutemodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="text" disabled name="name" id="infofounder" class="form-control " placeholder="Name">	
                    </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                    <label  for="name">CEO:</label>
                    <input type="text" disabled name="name" id="infoceo" class="form-control " placeholder="Name">	
                  </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
                  <label  for="name">Status:</label>
                  <select type="select" disabled  name="name" id="infostatus" class="form-control " placeholder="Name">	
                  <option value="1">Active</option>
                  <option value="0">Block</option>
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="date" disabled name="name" id="infocreate" class="form-control " placeholder="Name">	
                </div>
            </div>
    ...
    <div class="col-md-6">
      <div class="mb-3">
        ...
        <input type="text" disabled name="name" id="infoupdate" class="form-control " placeholder="Name">	
      </div>
  </div>
    
<div class="col-md-6">
  <button type="button" class="btn btn-md btn-secondary" id="infoclose" data-bs-dismiss="modal">Close</button>
              ...
              <button id='adddep' class=" btn-md btn btn-primary bottom-0">Add </button>
                  ...
                  <div class="modal fade" id="depmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      ...
                      <div class="col-md-12 pb-2">
                        <div class="mb-10">
                          <button type="button" class="btn btn-sm btn-secondary form-control" id="depclose" data-bs-dismiss="modal">Close</button>
  ...
  if (willDelete) {
   ...
   $('body').on('click','.infobutton', function () {
        ...
        $.ajax({
         ...
         $('#infostatus option[value="'+ response.status +'"]').attr('selected', 'selected')
         $('#infocity option[value="'+ response.city +'"]').attr('selected', 'selected')
          ...
          jQuery.fn.depfun = function(){ $.ajax({
           ...
           $.each(response ,function (key, value) {                                                         
                          $("#deplist").append('<tr><td>' + value.department_name + 
                            '</td><td><a  href="javascript:void(0)"  at="'+value.Did+
          ...
          $('#institute_id').val(institute_id)  
            $.ajax({
                ...
                success: function (response) {
                  ...
                  $.each(response ,function (key, value) {                                                         
                          $("#depselect").append('<option class="form-control" value="'+value.Did+'">'+value.department_name+'</option>');
                        });  
