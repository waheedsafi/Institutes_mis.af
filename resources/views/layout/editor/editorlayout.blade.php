...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            @else
            @endif
            @if (auth()->user()->hasPermissionTo('view-institute'))
                <li id="view-institute">
                    <a href="{{ route('editor.institute') }}">
            ...
            @else
            @endif
            @if (auth()->user()->hasPermissionTo('view-subject'))
                <li id="view-subject">
                    <a href="{{ route('editor.subject') }}">
            ...
            @if (auth()->user()->hasPermissionTo('view-curriculum'))
                <li id="view-curriculum">
                    <a href="{{ route('editor.curriculum') }}">
                        <i class='bx bxs-book'></i>
                        <span class="text">Carriculums</span>
                    </a>
                </li>
            @else
            @endif
            ...
            <li id="view-summarycurriculum">
                <a href="{{ route('editor.summarycurriculum') }}">
                    <i class='bx bxs-book'></i>
                    <span class="text">Carriculum PDF</span>
                </a>
            </li>
        @else
        @endif
